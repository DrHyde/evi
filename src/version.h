...
#define VIM_VERSION_MAJOR		10
#define VIM_VERSION_MINOR		0
#define VIM_VERSION_BUILD		0
#define VIM_VERSION_DATE_ONLY		"2026 Mar"
 ...
 */
#define VIM_VERSION_NODOT     "evi" VIM_VERSION_MAJOR_STR VIM_VERSION_MINOR_STR
#define VIM_VERSION_SHORT     VIM_VERSION_MAJOR_STR "." VIM_VERSION_MINOR_STR
#define VIM_VERSION_MEDIUM    VIM_VERSION_SHORT
#define VIM_VERSION_LONG_ONLY "EVi - Vi for Programmers, not AI users. " VIM_VERSION_MEDIUM
